...
public class MessageConstants {
    ...
    public static final String VERIFICATION_LINK_SENT = "VERIFICATION LINK SENT";
    public static String TOO_MANY_REQUESTS = "TOO MANY REQUESTS";
    public static String VERIFICATION_LINK_EXPIRED = "VERIFICATION LINK EXPIRED";
    public static String EMAIL_VERIFIED_SUCCESSFULLY = "EMAIL_VERIFIED_SUCCESSFULLY";
    ...
    public static String REFRESH_TOKEN_GENERATED = "REFRESH_TOKEN_GENERATED";
